 ...
 *
 */
declare module '@bryntum/schedulerpro/schedulerpro.lwc.module.js' {
    ...
    type ResourceAllocationIntervalInfo = {
    ...
    type AssignmentAllocationIntervalInfo = {
    ...
    export class Store extends Base implements EventsClass, StoreFilterClass, StoreChangesClass, StoreCRUDClass, StoreSumClass, StoreSearchClass, StoreSortClass, StoreGroupClass, StoreChainedClass, StoreStateClass, StoreTreeClass, StoreStmClass, StoreSyncClass {
        ...
        resumeEvents(): boolean;
        revertChanges(): void;
        search(text: string, fields: object[], searchAllRecords?: boolean): object[];
    ...
    export class ModelLinkClass {
        readonly hasLinks: boolean
        readonly isLinked: boolean
        constructor(config?: Partial<ModelLinkClassConfig>);
        link(): typeof Proxy;
    }
    ...
    export class CoreStateTrackingManager extends Base implements EventsClass {
        ...
        onRestoringStart: Function
        onRestoringStop: Function
        constructor(config?: Partial<CoreStateTrackingManagerConfig>);
        addListener(config: object|string, thisObj?: object|Function, oldThisObj?: object): Function;
    ...
    type ActionColumnConfig = {
        ...
        exportedType: string
        field: string
        filterType: 'string'|'date'|'number'|'int'|'duration'
    ...
    export class SchedulerAssignmentStore extends AjaxStore implements AssignmentStoreMixinClass, SchedulerPartOfProjectClass {
        ...
        addAsync(records: SchedulerAssignmentModel|SchedulerAssignmentModel[]|object|object[]|Partial<SchedulerAssignmentModelConfig>|Partial<SchedulerAssignmentModelConfig>[], silent?: boolean): Promise<SchedulerAssignmentModel[]>;
    ...
    export class SchedulerDependencyStore extends AjaxStore implements SchedulerPartOfProjectClass, DependencyStoreMixinClass {
        ...
        addAsync(records: SchedulerDependencyModel|SchedulerDependencyModel[]|object|object[]|Partial<SchedulerDependencyModelConfig>|Partial<SchedulerDependencyModelConfig>[], silent?: boolean): Promise<SchedulerDependencyModel[]>;
    ...
    export class SchedulerEventStore extends AjaxStore implements SchedulerPartOfProjectClass, SharedEventStoreMixinClass, EventStoreMixinClass, RecurringEventsMixinClass, GetEventsMixinClass {
        ...
        addAsync(records: SchedulerEventModel|SchedulerEventModel[]|object|object[]|Partial<SchedulerEventModelConfig>|Partial<SchedulerEventModelConfig>[], silent?: boolean): Promise<SchedulerEventModel[]>;
    ...
    export class SchedulerResourceStore extends AjaxStore implements SchedulerPartOfProjectClass, ResourceStoreMixinClass {
        ...
        addAsync(records: SchedulerResourceModel|SchedulerResourceModel[]|object|object[]|Partial<SchedulerResourceModelConfig>|Partial<SchedulerResourceModelConfig>[], silent?: boolean): Promise<SchedulerResourceModel[]>;
    ...
    export class EventCopyPaste extends InstancePlugin {
        ...
        clearClipboard(): void;
        copyEvents(records?: SchedulerEventModel[]|SchedulerAssignmentModel[], isCut?: boolean): void;
    ...
    export class EventEdit extends EditBase implements RecurringEventEditClass {
        ...
        readonly eventRecord: SchedulerEventModel
        readonly isEditing: boolean
    ...
    export class DragCreateBase extends SchedulerEventResize {
    ...
    type SchedulerProjectModelConfig = {
        ...
        stm: object|CoreStateTrackingManager|Partial<CoreStateTrackingManagerConfig>
    ...
    type SchedulerConfig = {
        ...
        milestoneTextPosition: 'inside'|'outside'
        minHeight: string|number
        minWidth: string|number
        minZoomLevel: number
        modal: boolean
    ...
    export class SchedulerBase extends TimelineBase implements DescribableClass, EventNavigationClass, EventSelectionClass, SchedulerDomClass, SchedulerDomEventsClass, SchedulerEventRenderingClass, SchedulerRegionsClass, SchedulerScrollClass, SchedulerStateClass, SchedulerStoresClass, TimelineDateMapperClass, TimelineDomEventsClass, TimelineEventRenderingClass, TimelineScrollClass, TimelineViewPresetsClass, TimelineZoomableClass, CrudManagerViewClass, ProjectConsumerClass {
        ...
        createEvent(date: Date, resourceRecord: SchedulerResourceModel): Promise<void>;
        ...
        resolveDependencyRecord(element: HTMLElement): SchedulerDependencyModel;
        resolveEventRecord(elementOrEvent: HTMLElement|Event): SchedulerEventModel;
        resolveResourceRecord(elementOrEvent: HTMLElement|Event, xy?: number[]): SchedulerResourceModel;
        resolveResourceTimeRangeRecord(rangeElement: HTMLElement): ResourceTimeRangeModel;
        resolveRowRecord(elementOrEvent: HTMLElement|Event): SchedulerResourceModel;
        ...
        scrollAssignmentIntoView(assignmentRecord: SchedulerAssignmentModel, options?: object): Promise<any>;
        ...
        scrollResourceEventIntoView(resourceRecord: SchedulerResourceModel, eventRecord: SchedulerEventModel, options?: object): Promise<any>;
    ...
    export class ResourceFilter extends List {
        readonly value: SchedulerResourceModel[]
        onChange: Function
    ...
    export class AssignmentStore extends AjaxStore implements PartOfProjectClass, AssignmentStoreMixinClass {
    ...
    export class CalendarManagerStore extends AjaxStore implements PartOfProjectClass {
        readonly assignmentStore: AssignmentStore
        readonly calendarManagerStore: CalendarManagerStore
        readonly dependencyStore: DependencyStore
        readonly eventStore: EventStore
    ...
    type EventSegmentDragConfig = {
        ...
        validatorFn: Function
        validatorFnThisObj: object
        onAfterEventSegmentDrop: Function
        onBeforeEventSegmentDrag: Function
        onBeforeEventSegmentDropFinalize: Function
        onEventSegmentDrag: Function
        onEventSegmentDragAbort: Function
        onEventSegmentDragReset: Function
        onEventSegmentDragStart: Function
        onEventSegmentDrop: Function
    }
    ...
    type EventSegmentResizeConfig = {
        ...
        validatorFn: Function
        validatorFnThisObj: object
        onBeforeEventSegmentResize: Function
        onBeforeEventSegmentResizeFinalize: Function
        onEventSegmentPartialResize: Function
        onEventSegmentResizeEnd: Function
        onEventSegmentResizeStart: Function
    }
    ...
    export class EventSegmentResize extends EventResize {
        ...
        onEventSegmentResizeEnd: Function
        onEventSegmentResizeStart: Function
        constructor(config?: Partial<EventSegmentResizeConfig>);
    }
    ...
    type EventSegmentsConfig = {
        ...
        localizable: boolean
        localizableProperties: string[]
        maxSplitDuration: Duration|object|number
        minSplitDuration: Duration|object|number
        splitDuration: Duration|object|number
    }

    export class EventSegments extends InstancePlugin {
        constructor(config?: Partial<EventSegmentsConfig>);
        getSplitDate(context: object): Date;
        getSplitDuration(context: object): number;
        getSplitDurationUnit(context: object): string;
    }
    ...
    export class NestedEvents {
        ...
        headerHeight: number
        resourceMargin: number
        constructor(config?: Partial<NestedEventsConfig>);
    }
    ...
    type TaskEditConfig = {
        ...
        onTaskEditCanceled: Function
    }

    export class TaskEdit extends InstancePlugin implements ProTaskEditStmClass, DelayableClass {
        readonly isEditing: boolean
        onAfterEventSave: Function
        onAfterTaskEdit: Function
        onAfterTaskSave: Function
    ...
    export class CalendarModel extends Model implements PartOfProjectClass {
        readonly assignmentStore: AssignmentStore
        readonly calendarManagerStore: CalendarManagerStore
        cls: string
        readonly dependencyStore: DependencyStore
    ...
    export class DependencyModel extends DependencyBaseModel implements PartOfProjectClass {
        active: boolean
        readonly assignmentStore: AssignmentStore
        calendar: CalendarModel
        readonly calendarManagerStore: CalendarManagerStore
    ...
    export class EventModel extends TimeSpan implements RecurringTimeSpanClass, EventModelMixinClass, PercentDoneMixinClass, PartOfProjectClass {
        ...
        setEffort(effort: number, unit?: string): Promise<void>;
    ...
    export class EventSegmentModel extends TimeSpan implements EventModelMixinClass, PercentDoneMixinClass {
        ...
        constructor(config?: Partial<EventSegmentModelConfig>);
        assign(resource: SchedulerResourceModel|string|number|SchedulerResourceModel[]|string[]|number[], removeExistingAssignments?: boolean): void;
        getResource(resourceId?: string): SchedulerResourceModel;
        isAssignedTo(resource: SchedulerResourceModel|string|number): boolean;
        isEditable(fieldName: string): boolean;
    ...
    export class ProjectModel extends ProjectModelMixinClass implements EventsClass, PartOfProjectClass, ProjectCrudManagerClass, ProjectChangeHandlerMixinClass {
        readonly assignmentStore: AssignmentStore
        assignments: AssignmentModel[]|object[]|Partial<AssignmentModelConfig>[]
        calendar: string|object|CalendarModel|Partial<CalendarModelConfig>
        readonly calendarManagerStore: CalendarManagerStore
    ...
    type ResourceHistogramConfig = {
        ...
        zoomOnMouseWheel: boolean
        zoomOnTimeAxisDoubleClick: boolean
        onGenerateScalePoints: Function
    }

    export class ResourceHistogram extends SchedulerProBase {
        readonly scaleColumn: ScaleColumn
        ...
        getBarTextDefault(datum: ResourceAllocationIntervalInfo, index: number): string;
    ...
    export class SchedulerProBase extends SchedulerBase implements SchedulerProEventRenderingClass, ProjectProgressMixinClass, SchedulingIssueResolutionClass {
        ...
        eventLayout: string|object|'stack'|'pack'|'mixed'|'none'
    ...
    type SchedulerProEventRenderingClassConfig = {
        eventLayout: 'stack'|'pack'|'mixed'|'none'|EventLayoutConfig
    }
